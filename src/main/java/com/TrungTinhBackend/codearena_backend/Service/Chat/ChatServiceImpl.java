...
//            }
        ...
        NotificationDTO notificationDTO = (NotificationDTO) notificationService.sendSystemNotification(user2.getId(), user1.getUsername() +" vừa gửi tin nhắn cho bạn", "COURSE", 1L).getData();
